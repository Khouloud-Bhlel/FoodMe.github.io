    ...
    async confirmAccount() {
      try {
        ...
        if (token) {
          ...
          // If token is missing, it means the user directly navigated to this page
          // You can display a message indicating that the confirmation link was sent to their email
