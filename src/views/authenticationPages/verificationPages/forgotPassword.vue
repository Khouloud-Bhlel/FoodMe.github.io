  ...
  <div class="page">
    ...
    <form @submit.prevent="sendVerificationEmail">
      <div class="v-card-text pt-2">
        <h4 class="text-h4 mb-1">Forgot Password? <span class="lock">🔒</span></h4>
        <p class="instruction">Enter your email, and we'll send you instructions to reset your password</p>
      </div>
      <div class="row">
        <div class="col-12">
          <input 
        ...
        <div class="social">
            ...
            <button @click.prevent="returnToLogin" class="mr-2">Return to Login</button>
